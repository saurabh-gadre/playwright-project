...
test.describe('Home Page Validations', () => {
    ...
    test('Click Get Started Button using CSS Selector', async ({ page }) => {
     ...
     test('Verify Heading Text using Text Selector', async ({ page }) => {
        await page.goto("https://practice.sdetunicorns.com/");
        const headingText = await page.locator('text=Think different. Make Different.'); // Case Insensitive
     ...
     test('Verify Home Link using Text and CSS Selector', async ({ page }) => {
        ...
        const homeLink = page.locator('#zak-primary-menu:has-text("Home")');
        await expect(homeLink).toBeEnabled();
     });

     test('Verify Search Button using Xpath Selector', async ({ page }) => {
        await page.goto("https://practice.sdetunicorns.com/");
        const searchBtn = page.locator('//div[@class="zak-header-actions zak-header-actions--desktop"]//a[@class="zak-header-search__toggle"]');
     ...
     test('Verify Text for All Links', async ({ page }) => {
        ...
        await page.goto("https://practice.sdetunicorns.com/");
        const menuLinks = page.locator('#zak-primary-menu li');
      ...
      //   }
        ...
        const contactText = await page.locator('#zak-primary-menu li').nth(4).textContent();  
